...
@page{size:A4 portrait;margin:5mm}*{box-sizing:border-box}body{margin:0;font-family:Arial,Helvetica,sans-serif;color:#555}.page{height:287mm;display:flex;flex-direction:column;justify-content:space-between;page-break-after:always}.page:last-child{page-break-after:auto}.nri-preview-label{height:92mm;width:100%;border:1.2px solid #666;background:#fff;color:#555;overflow:hidden}.nri-top{display:grid;grid-template-columns:auto 1fr auto;align-items:center;height:8mm;border-bottom:1px solid #666}.nri-code-label{padding:.7mm 2.2mm;font-size:14pt;font-weight:800;border-right:1px solid #666}.nri-code-value{padding:.4mm 3mm;font-size:23pt;line-height:1;font-weight:1000}.nri-id{padding:.6mm 2mm;font-size:10pt;font-weight:900}.nri-product-title{height:18mm;border-bottom:1px solid #666;display:flex;align-items:center;justify-content:center;gap:3mm;padding:1mm 3mm;text-align:center}.nri-product-title img{width:14mm;height:14mm;object-fit:contain}.nri-product-title strong{font-size:24pt;line-height:.96;font-weight:1000;letter-spacing:.1mm}.nri-mini-strip{display:grid;grid-template-columns:1fr 1fr;height:6mm;border-bottom:1px solid #666}.nri-mini-cell{display:flex;align-items:center;padding:.5mm 2mm;font-size:9pt;font-weight:700}.nri-mini-cell+.nri-mini-cell{border-left:1px solid #666}.nri-mini-cell b{font-size:8.5pt;font-weight:1000;text-transform:uppercase;margin-right:1.3mm}.nri-validade{display:grid;grid-template-columns:31% 69%;align-items:center;height:28mm;border-bottom:1px solid #666}.nri-validade span{height:100%;display:flex;align-items:center;padding:1.5mm 2.5mm;border-right:1px solid #666;font-size:25pt;font-weight:1000;letter-spacing:-.3mm}.nri-validade strong{font-size:46pt;line-height:.9;text-align:center;font-weight:1000;letter-spacing:.35mm;color:#000}.nri-dates{display:grid;grid-template-columns:1fr 1fr;height:10mm;border-bottom:1px solid #666}.nri-date-cell{display:grid;grid-template-columns:auto 1fr;align-items:center}.nri-date-cell+.nri-date-cell{border-left:1px solid #666}.nri-date-cell b{padding:1mm 1.8mm;font-size:10.5pt;font-weight:1000}.nri-date-cell strong{text-align:center;padding:1mm 1.4mm;border-left:1px solid #666;font-size:13.5pt;line-height:1;font-weight:1000}.nri-meta{display:grid;grid-template-columns:1.55fr .85fr .8fr 1.15fr 1fr;height:10mm;border-bottom:1px solid #666}.nri-meta-cell{text-align:center;border-right:1px solid #666;overflow:hidden}.nri-meta-cell:last-child{border-right:0}.nri-meta-cell b{display:block;padding:.35mm .7mm 0;font-size:7.8pt;line-height:1;font-weight:1000;text-decoration:underline;text-transform:uppercase}.nri-meta-cell span{display:block;padding:.2mm .7mm .2mm;font-size:9.6pt;line-height:1;font-weight:700;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.nri-bottom{display:grid;grid-template-columns:1.8fr .75fr 1.1fr;height:9mm}.nri-bottom>div{display:flex;align-items:center;padding:.7mm 1.6mm;font-size:9.5pt;line-height:1;font-weight:700;border-right:1px solid #666;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.nri-bottom>div:last-child{border-right:0}.nri-bottom b{font-size:9pt;font-weight:1000;text-transform:uppercase;margin-right:1.2mm}
